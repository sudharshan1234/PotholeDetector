    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA) ||
        ...
        Toast.makeText(CameraActivity.this,
            "Camera,storage and location permissions are required for this demo", Toast.LENGTH_LONG).show();
      }
      requestPermissions(new String[] {PERMISSION_CAMERA, PERMISSION_STORAGE,PERMISSION_INTERNET,PERMISSION_FINE_LOCATION}, PERMISSIONS_REQUEST);
    }
  }
